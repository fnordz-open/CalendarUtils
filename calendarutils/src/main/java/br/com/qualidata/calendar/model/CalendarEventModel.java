...
import br.com.qualidata.calendar.EventColorCache;
import br.com.qualidata.calendar.GeneralPreferences;
import br.com.qualidata.calendar.Rfc822Validator;
...
public class CalendarEventModel implements Serializable {
    ...
    public void addAttendees(String attendees, Rfc822Validator validator) {
        final LinkedHashSet<Rfc822Token> addresses = getAddressesFromList(
                attendees, validator);
        synchronized (this) {
